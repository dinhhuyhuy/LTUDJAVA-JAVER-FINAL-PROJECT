...
import uichatapp.ChatBoxGroup;
import uichatapp.ChatBoxUser;
import uichatapp.ChatMessageBlock;
import uichatapp.ItemChatAccount;
...
public class MenuChat extends JPanel {
    ...
    public void fillFriendList() {
        ...
        for (; index < onlineUser.size(); index++) {
            if (!onlineUser.get(index).getOnline())
                break;
            ItemChatAccount chatAccount = new ItemChatAccount(onlineUser.get(index).getID(),
                    onlineUser.get(index).getUsername(), onlineUser.get(index).getOnline());
        ...
        for (; indexGroup < onlineGroup.size(); indexGroup++) {
            if (!onlineGroup.get(indexGroup).getOnline())
                break;
            ItemChatAccount chatGroupItem = new ItemChatAccount(onlineGroup.get(indexGroup).getID(),
                    onlineGroup.get(indexGroup).getGroupname(), onlineGroup.get(indexGroup).getOnline());
        ...
        for (Message message : allChat) {
            ...
            if (message.getUserName().equals(user.getUsername())) {
                messageBlock = new ChatMessageBlock(message.getUserName(), message.getDateSend(), ChatMessageBlock.MINE,
                        message.getContent());
            } else {
                messageBlock = new ChatMessageBlock(message.getUserName(), message.getDateSend(),
                        ChatMessageBlock.OTHER, message.getContent());
            }
                ...
                sidePanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(sidePanelLayout.createSequentialGroup()
                                .addGroup(sidePanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        .addGroup(sidePanelLayout.createSequentialGroup()
                                                .addGap(50, 50, 50)
                                                .addComponent(refreshButton, javax.swing.GroupLayout.PREFERRED_SIZE,
                                                        301, javax.swing.GroupLayout.PREFERRED_SIZE))
                                        .addGroup(sidePanelLayout.createSequentialGroup()
                                                .addGap(39, 39, 39)
                                                .addComponent(jScrollPaneListFriend,
        ...
        sidePanelLayout.setVerticalGroup(
                sidePanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(sidePanelLayout.createSequentialGroup()
                                ...
                                .addGap(44, 44, 44)
                                .addComponent(jScrollPaneListFriend, javax.swing.GroupLayout.PREFERRED_SIZE, 534,
                                        javax.swing.GroupLayout.PREFERRED_SIZE)
