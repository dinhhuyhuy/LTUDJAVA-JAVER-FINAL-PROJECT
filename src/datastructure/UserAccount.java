...
public class UserAccount {
    ...
    public UserAccount(int ID, String username, String password, String fullname, String address, String birthDay,
            String gender, String email, boolean online) {
        this.ID = ID;
    ...
    public String toString() {
        String result = String.format("{%d, %s, %s, %s, %b}", this.ID, this.username, this.fullname, this.email,
                this.online);
        return result;
    }
