...
public class DetailGroupChatForm extends javax.swing.JFrame {
    ...
    private uichatapp.SearchBar searchBarFriendGroup;
    ...
    public void enableAdmin() {
        DatabaseManagment database = DatabaseManagment.getInstance();
        if (!isAdmin) {
            JOptionPane.showMessageDialog(null, "You do not have permission to assign admin role", "Permission denied",
        ...
        if (row < 0) { // Cảnh báo chưa chọn dòng nào trong bảng
            ...
            int response = JOptionPane.showConfirmDialog(this, "Bạn có chắc chắn không?", "Confirm",
    ...
    public void changeGroupName() {
        ...
        if (!isAdmin) {
            JOptionPane.showMessageDialog(null, "You do not have permission to change group name", "Permission denied",
                    JOptionPane.WARNING_MESSAGE);
            return;
        }
        ...
        if (JOptionPane.showConfirmDialog(null, changeGroupPanel, "Change group name", JOptionPane.OK_CANCEL_OPTION,
    ...
    public void removeMember() {
        ...
        if (!isAdmin) {
            JOptionPane.showMessageDialog(null, "You do not have permission to remove members from the group",
        ...
        String isChoosen_ID = tableMemberGroup.getModel().getValueAt(row, 0).toString().trim();
        // String position = tableMemberGroup.getModel().getValueAt(row,
        // 3).toString().trim();

        int response = JOptionPane.showConfirmDialog(this, "Bạn có chắc chắn xóa người này không?", "Confirm",
                JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE);
        if (response == 0) {
    ...
    private void initComponents() {
        try {
            ...
            java.util.logging.Logger.getLogger(DetailGroupChatForm.class.getName()).log(java.util.logging.Level.SEVERE,
                    null, ex);
        ...
        searchBarFriendGroup = new uichatapp.SearchBar();
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                        ...
                                        .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel1Layout
                                                ...
                                                .addGroup(jPanel1Layout
                                                        ...
                                                        .addComponent(searchBarFriendGroup,
                                                ...
                                                .addGroup(jPanel1Layout
                                                        ...
                                                        .addComponent(changeGroupNameButton,
                                                                ...
                                                                javax.swing.GroupLayout.PREFERRED_SIZE)
                                                        .addComponent(enableAdminButton,
                                                                javax.swing.GroupLayout.Alignment.TRAILING,
                                                                javax.swing.GroupLayout.PREFERRED_SIZE, 182,
                                                                javax.swing.GroupLayout.PREFERRED_SIZE))))
                                .addGap(33, 33, 33)));
                ...
                jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                        .addComponent(jLabel_danhsachthanhvien, javax.swing.GroupLayout.PREFERRED_SIZE,
                                                36, javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addComponent(jLabelGroupName, javax.swing.GroupLayout.PREFERRED_SIZE, 33,
                                                javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addComponent(addMemberButton, javax.swing.GroupLayout.PREFERRED_SIZE, 36,
                                                javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addComponent(changeGroupNameButton, javax.swing.GroupLayout.PREFERRED_SIZE, 36,
                                                javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addGap(20, 20, 20)
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                        .addComponent(searchBarFriendGroup, javax.swing.GroupLayout.PREFERRED_SIZE,
                                                javax.swing.GroupLayout.DEFAULT_SIZE,
                                                javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addComponent(removeMemberButton, javax.swing.GroupLayout.PREFERRED_SIZE, 36,
                                                javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addComponent(enableAdminButton, javax.swing.GroupLayout.PREFERRED_SIZE, 36,
                                                javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addGap(18, 18, 18)
