...
public class ChatBoxGroup extends ChatBoxLayout {
    ...
    private void sendMessage() {
        ...
        String packetSend = ChatService.createPacket(ChatService.CHATGROUP, groupChat.getID(), message,
                formattedsendTime);
        user.sendPacket(packetSend);
    }

    public void addMessage(Message message) {
        this.addMessage(new ChatMessageBlock(message.getUserName(), message.getDateSend(), ChatMessageBlock.OTHER,
                message.getContent()));
    }
                ...
                headerGroupLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(headerGroupLayout.createSequentialGroup()
                                ...
                                .addGroup(headerGroupLayout
                                        ...
                                        .addComponent(viewGroupInforButton, javax.swing.GroupLayout.DEFAULT_SIZE,
                        ...
                        .addGroup(headerGroupLayout.createSequentialGroup()
                                ...
                                .addGroup(headerGroupLayout
                                        ...
                                        .addComponent(searchBarChat, javax.swing.GroupLayout.PREFERRED_SIZE,
                                                ...
                                                javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(viewGroupInforButton, javax.swing.GroupLayout.PREFERRED_SIZE, 29,
                                        javax.swing.GroupLayout.PREFERRED_SIZE)
