...
return;
        ...
        private void lockAccount() {
                ...
                if (database.checkAccountIsBanned(user.getID())) {
                        if (JOptionPane.showConfirmDialog(this, "Are you sure you want to unban this account?",
                                        "Confirm unban",
                        ...
                        if (JOptionPane.showConfirmDialog(this, "Are you sure you want to ban this account?",
                                        "Confirm ban",
                                        JOptionPane.YES_NO_OPTION) == JOptionPane.YES_OPTION) {
        ...
        private void initComponents() {
                try {
                        ...
                        java.util.logging.Logger.getLogger(DetailAccountForm.class.getName()).log(
